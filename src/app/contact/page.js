...
export default function Example() {
    ...
    return (
        <>
            ...
            <div className="flex flex-col sm:flex-row lg:px-10 md:px-5 px-2">
            ...
            <div className="bg-[#51270f] w-full lg:px-10 md:px-5 px-2 py-10 my-10 flex justify-center items-center">
                <div className="bg-[#47271595] border-2 w-full flex flex-col justify-center md:items-center gap-5 p-16 rounded-xl">
                    <h1 className="md:text-5xl sm:text-xl text-base font-bold text-white text-center w-full">Follow Us On <span className="text-yellow-500">Social Media </span>Platforms</h1>
                    <p className="md:text-lg text-sm text-white w-full">We understand the importance of staying connected. Feel free to follow us on our social media profiles for the latest updates, braiding tips, and more:</p>
                    <ul className="flex gap-4 md:flex-row flex-col text-white">
                        {
